...
const gpioInitConfig gpioConfig[] = 
{
    ...
    // ADC
    { GPIOA, {GPIO_PIN_0 | GPIO_PIN_1 ,  GPIO_MODE_ANALOG   , GPIO_NOPULL, GPIO_SPEED_FREQ_LOW}},

    // GPS - UART
    { GPIOA, {GPIO_PIN_9              ,  GPIO_MODE_AF_PP    , GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH}},
    { GPIOA, {GPIO_PIN_10             ,  GPIO_MODE_AF_INPUT , GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH}},

    // DEBUG - UART
    { GPIOB, {GPIO_PIN_10             ,  GPIO_MODE_AF_PP    , GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH}},
    { GPIOB, {GPIO_PIN_11             ,  GPIO_MODE_AF_INPUT , GPIO_NOPULL, GPIO_SPEED_FREQ_HIGH}}
};
